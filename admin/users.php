      ...
      <div class="w3-card-4 w3-white">
        ...
        <div class="">
          ...
          <table class="w3-table-all w3-hide-small" style="width:100%">
            ...
            $sql = "SELECT id, voornaam, achternaam, email, priv FROM Gebruikers";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while($row = mysqli_fetch_assoc($result)) {
                  ...
                  $priv0 = $priv1 = $priv2 = null;

                  if ($row['priv'] == 0){$priv0 = "selected";} elseif ($row['priv'] == 1){$priv1 = "selected";} elseif ($row['priv'] == 2){$priv2 = "selected";}

                  echo "<tr>";

                  echo "  <td>".$row["id"]."</td>";

                  echo "  <td>".$row["voornaam"]."<br>".$row["achternaam"]."</td>";
          ...
          <table class="w3-table-all w3-hide-large w3-hide-medium" style="width:100%">
            ...
            if (mysqli_num_rows($result) > 0) {
              ...
              while($row = mysqli_fetch_assoc($result)) {
                ...
                echo "  <td>".$row["voornaam"]." ".$row["achternaam"]."<span class=\"w3-right\"><b>Id:</b> ".$row["id"]."</span><br><span class=\"w3-tiny\">".$row["email"]."</span></td>";
