...
if (isset($_GET['route'])){
  if ($_GET['route'] == "true"){
    ...
    $deelgebieden = array("Alpha","Bravo","Charlie","Delta","Echo","Foxtrot");
    ...
    foreach ($deelgebieden as $deelgebied) {
      ...
      if (mysqli_num_rows($result) > 0) {
        ...
        if (ucfirst($deelgebied) == "Alpha") {
          $color = "#9829FF";
        } elseif (ucfirst($deelgebied) == "Bravo") {
          $color = "#2F9CEB";
        } elseif (ucfirst($deelgebied) == "Charlie") {
          $color = "#2DFF69";
        } elseif (ucfirst($deelgebied) == "Delta") {
          $color = "#F5F02C";
        } elseif (ucfirst($deelgebied) == "Echo") {
          $color = "#FFA12E";
        } elseif (ucfirst($deelgebied) == "Foxtrot") {
          $color = "#F52E2B";
        } else {
          $color = "#000000";
        }
...
if (isset($_GET['hints'])){
  if ($_GET['hints'] == "true"){
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      $i = 0;
      while($row = mysqli_fetch_assoc($result)) {
        if (ucfirst($row['deelgebied']) == "Alpha") {
          $color = "#9829FF";
        } elseif (ucfirst($row['deelgebied']) == "Bravo") {
          $color = "#2F9CEB";
        } elseif (ucfirst($row['deelgebied']) == "Charlie") {
          $color = "#2DFF69";
        } elseif (ucfirst($row['deelgebied']) == "Delta") {
          $color = "#F5F02C";
        } elseif (ucfirst($row['deelgebied']) == "Echo") {
          $color = "#FFA12E";
        } elseif (ucfirst($row['deelgebied']) == "Foxtrot") {
          $color = "#F52E2B";
        } else {
          $color = "#000000";
        }
